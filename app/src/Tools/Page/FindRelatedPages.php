...
class FindRelatedPages implements ToolInterface
{
    ...
    public function execute(array $args): ?ToolResult
    {
        try {
            ...
            return new ToolResult(true, 'Related pages found successfully', [
                'source_page' => [
                    'id' => $page->id,
                    'title' => $page->title,
                ],
            ...
            return new ToolResult(false, 'Failed to find related pages: ' . $e->getMessage(), ['code' => 'FIND_RELATED_ERROR', 'exception' => get_class($e)]);
        }
    }
